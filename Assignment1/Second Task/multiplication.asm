...
multiplication.exe:     file format pei-i386
...
00401000 <.text>:
  ...
  4011b7:	a1 78 50 40 00       	mov    0x405078,%eax
...
00401de0 <.text>:
  ...
  401dfe:	c7 04 24 7c 50 40 00 	movl   $0x40507c,(%esp)
  ...
  401f13:	00 
  401f14:	c7 04 24 94 50 40 00 	movl   $0x405094,(%esp)
...
00401f20 <__pei386_runtime_relocator>:
  ...
  401f30:	b8 00 53 40 00       	mov    $0x405300,%eax
  401f35:	c7 05 60 70 40 00 01 	movl   $0x1,0x407060
  401f3c:	00 00 00 
  401f3f:	2d e8 52 40 00       	sub    $0x4052e8,%eax
  ...
  401f9b:	81 fb 00 53 40 00    	cmp    $0x405300,%ebx
  ...
  401fe1:	c7 04 24 fc 50 40 00 	movl   $0x4050fc,(%esp)
  401fe8:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  401fef:	00 
  401ff0:	e8 eb fd ff ff       	call   401de0 <.text>
  401ff5:	bb e8 52 40 00       	mov    $0x4052e8,%ebx
  401ffa:	81 fb 00 53 40 00    	cmp    $0x405300,%ebx
  ...
  402028:	81 fb 00 53 40 00    	cmp    $0x405300,%ebx
  ...
  402040:	bb e8 52 40 00       	mov    $0x4052e8,%ebx
  ...
  4020df:	c7 04 24 c8 50 40 00 	movl   $0x4050c8,(%esp)
...
004021a0 <.text>:
  ...
  4028f9:	bf 28 51 40 00       	mov    $0x405128,%edi
...
004031c0 <___mingw_globfree>:
  ...
  4031ca:	81 3e 2a 51 40 00    	cmpl   $0x40512a,(%esi)
...
00403220 <___mingw_dirname>:
  ...
  40324d:	c7 44 24 04 3c 51 40 	movl   $0x40513c,0x4(%esp)
  403254:	00 
  ...
  403277:	00 
  403278:	c7 44 24 04 3e 51 40 	movl   $0x40513e,0x4(%esp)
  40327f:	00 
  ...
  4032a9:	c7 44 24 04 3e 51 40 	movl   $0x40513e,0x4(%esp)
  4032b0:	00 
